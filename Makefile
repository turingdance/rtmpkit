...
PROGS=rtmpdump rtmpgw rtmpsrv rtmpsuck rtmppub rtmppub2
...
install:	$(PROGS)
	...
	cp rtmpdump$(EXT) rtmppub$(EXT) $(BINDIR)
...
clean:
	rm -f *.o rtmpdump$(EXT) rtmpgw$(EXT) rtmpsrv$(EXT) rtmpsuck$(EXT) rtmppub$(EXT)
...
rtmppub: rtmppub.o
	$(CC) $(LDFLAGS) -o $@$(EXT) $@.o $(LIBRTMP) $(CRYPTO_LIB) $(LIBS_$(SYS)) $(XLIBS)
...
rtmppub.o: rtmppub.c $(INCRTMP) Makefile
